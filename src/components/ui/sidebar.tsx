  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
        className={cn(
          "h-full text-sidebar-foreground transition-all duration-200 ease-in-out",
        ...
        {...props}
      >
        <div data-sidebar="sidebar" className={cn("flex h-full w-full flex-col bg-sidebar", {
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        {
          "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0": state === 'collapsed'
        },
        className
      )}
      {...props}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        {
          "group-data-[collapsible=icon]:hidden": state === 'collapsed'
        },
        className
      )}
      {...props}
        ...
        {React.Children.map(children, (child) => {
          if (React.isValidElement(child) && child.type === 'span') {
            return React.cloneElement(child as React.ReactElement, {
              className: cn(child.props.className, { 'hidden': state === 'collapsed' }),
            });
          }
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size }), {
          "justify-center !p-2": state === 'collapsed',
        }, className)}
        {...props}
      >
        {buttonContent}
